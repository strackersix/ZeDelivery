...
public interface PetStoreSwagger {
	...
	String inserirUsuariosEndpoint = "v2/user/createWithList";
	...
	String vendaPetParryAnaMaria = "v2/store/order";
	...
	String vendaPetSnoopyRodrigoMendes = "v2/store/order";
	...
	String vendaPetSnoopyTatianaVasconcelos = "v2/store/order";
