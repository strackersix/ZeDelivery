...
public class API extends BaseTest implements PetStoreSwagger {
	...
	public void T_01_inserirUsuarios () {
		...
		.when()
			.post(T_01_inserirUsuariosEndpoint)
		.then()
			.log().all()
			.statusCode(200)
	...
	public void T_03_vendaPetParryAnaMaria () {
		...
		.when()
			.post(T_03_vendaPetParryAnaMariaEndpoint)
		.then()
			.log().all()
			.statusCode(200)
			.body("id", is(1))
	...
	public void T_04_vendaPetSnoopyRodrigoMendes () {
		...
		.when()
			.post(T_04_vendaPetSnoopyRodrigoMendesEndpoint)
		.then()
			.log().all()
			.statusCode(200)
			.body("id", is(2))
	...
	public void T_05_vendaPetSnoopyTatianaVasconcelos () {
		...
		.when()
			.post(T_05_vendaPetSnoopyTatianaVasconcelosEndpoint)
		.then()
			.log().all()
			.statusCode(200)
			.body("id", is(3))
